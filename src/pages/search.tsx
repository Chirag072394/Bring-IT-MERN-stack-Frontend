...
import { useCatergoriesQuery, useSearchProductsQuery } from "../redux/api/productAPI";
...
function Search() {
  ...
  const {data:categoriesResponse,isLoading:loadingCategories,isError,error} = useCatergoriesQuery("")
